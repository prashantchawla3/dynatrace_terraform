...
variable "enable_calculated_synthetic_metric" { type = bool, default = true }
variable "enable_synthetic_availability" { type = bool, default = true }
variable "enable_synthetic_location" { type = bool, default = true }
